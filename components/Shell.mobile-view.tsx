      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-80 shrink-0 flex-col px-5 py-5 md:flex">
          <div className="glass flex h-full flex-col rounded-3xl px-5 py-6">
            ...
            <div className="mt-6 rounded-2xl border border-blue-400/15 bg-blue-500/[0.06] p-4">
              <p className="eyebrow">System</p>
              <p className="mt-2 text-sm text-white">Core services online</p>
              <p className="mt-1 text-xs leading-relaxed text-slate-400">
                Chat, history, memory extraction, document learning, tasks, Morning Sync, and search foundation are available.
              </p>
            </div>
          </div>
        </aside>
        ...
        <main className="flex-1 px-2 py-2 md:px-5 md:py-5 md:pr-8">
          <div className="sticky top-2 z-40 mb-3 flex items-center justify-between rounded-2xl border border-white/10 bg-slate-950/90 px-4 py-3 shadow-xl backdrop-blur-xl md:hidden">
            <div>
            ...
            <button
              ...
              className="rounded-xl border border-white/10 bg-white/[0.035] px-3 py-2 text-sm text-slate-100"
          ...
          {mobileMenuOpen && (
            <div className="fixed inset-0 z-50 md:hidden">
              ...
              <div className="absolute left-0 top-0 flex h-full w-[86%] max-w-sm flex-col border-r border-white/10 bg-slate-950 p-4 shadow-2xl">
                <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-4">
